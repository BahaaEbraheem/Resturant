...
{
    public abstract class ResturantWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ResturantWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ResturantWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ResturantDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ResturantDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ResturantDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ResturantDbContext, Task<T>> func)
        {
            T result;
