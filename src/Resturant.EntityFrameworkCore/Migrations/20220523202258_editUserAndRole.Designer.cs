...
namespace Resturant.Migrations
{
    ...
    [Migration("20220523202258_editUserAndRole")]
    partial class editUserAndRole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Resturant.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Resturant.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Resturant.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Resturant.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Resturant.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
